...
<div class=" relative">
    ...
    <div class="absolute  top-10 right-5 ">
        <?php if ($_SESSION['user'] ?? false) : ?>
                ...
                <div class="flex  flex-end flex-col right-0 items-center w-40 h-full   overflow-hidden text-gray-400 bg-gray-900 rounded">
                    ...
                    <div class="w-full px-2">
                        <div class="flex flex-col items-center w-full mt-3 border-t border-gray-700">
                            ...
                            <a class="flex items-center w-full h-12 px-3 mt-2 hover:text-gray-300 hover:bg-gray-700 rounded" href="#">
                                <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="content mr-0 transition-all">
                <img src="https://i.ibb.co/7XY2njh/IMG-20240109-WA0017.jpg" alt="Profile Picture" onclick="openNav()" class=" openbtn border-gray-200 h-12 w-12 rounded-full">
            </div>
        <?php else : ?>
            <div class="ml-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.body.addEventListener('click', function(event) {
            // Check if the click target is not within the sidebar or open button
            if (!event.target.closest('.sidebar') && !event.target.closest('.openbtn')) {
                closeNav();
            }
        });
    })
    ...
    function openNav() {
        ...
        document.querySelector('.content').style.marginRight = "160px";
        document.querySelector('.blur-background').classList.add('bg-opacity-50');
    }

    function closeNav() {
        document.querySelector('.sidebar').style.width = "0";
        document.querySelector('.content').style.marginRight = "0";
        document.querySelector('.blur-background').classList.remove('bg-opacity-50');
    }
</script>